...
namespace EFModels.Migrations
{
    ...
    [Migration("20241122153212_addprices")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GenreUser", b =>
                {
                    b.Property<int>("FavouriteGernersId")
                        .HasColumnType("int");

                    b.Property<int>("UsersId")
                        .HasColumnType("int");

                    b.HasKey("FavouriteGernersId", "UsersId");
            ...
            modelBuilder.Entity("GenreUser", b =>
                {
                    b.HasOne("EFModels.Models.Genre", null)
                        .WithMany()
                        .HasForeignKey("FavouriteGernersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
